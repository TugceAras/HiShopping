...
// See the License for the specific language governing permissions and
// limitations under the License.
package com.hms.referenceapp.hishopping.data.repository.campaign
...
class CampaignRepositoryImpl @Inject constructor(private val localDataSource: CampaignLocalDataSource) :
    CampaignRepository {
    override fun getAll(): Flow<ResultData<List<Campaign>>> {
        return resultFlow {
