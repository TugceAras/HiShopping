...
class CampaignsRepositoryImpl @Inject constructor(
    @CampaignsDataSource private val getCampaignsDataSource:
    BaseResultFlowAsyncDataSource<List<@JvmSuppressWildcards Campaign>, @JvmSuppressWildcards Unit>
) : CampaignsRepository {
    override suspend fun getCampaigns(): Flow<ResultData<List<Campaign>>> {
        return getCampaignsDataSource.getResult()
    }
}