...
class DetailBodyRepositoryImpl  @Inject constructor(private val getProductDetailDataSource:
                                                    BaseResultFlowAsyncDataSource<Product, Int>
) : DetailBodyRepository {

    override suspend fun getProductDetail(query: Int): Flow<ResultData<Product>> {
        return getProductDetailDataSource.getResult(query)
    }
}