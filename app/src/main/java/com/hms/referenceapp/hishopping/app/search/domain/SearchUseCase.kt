...
// See the License for the specific language governing permissions and
// limitations under the License.
package com.hms.referenceapp.hishopping.app.search.domain
...
class SearchUseCase @Inject constructor(private val searchRepository: SearchRepository) :
    BaseResultFlowAsyncUseCase<List<@JvmSuppressWildcards Product>, String> {

    override suspend fun execute(params: String?): Flow<ResultData<List<Product>>> {
