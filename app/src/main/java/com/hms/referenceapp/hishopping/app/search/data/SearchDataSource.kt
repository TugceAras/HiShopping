...
class SearchDataSource @Inject constructor(private val productRepository: ProductRepository) :
    BaseResultFlowAsyncDataSource<List<@JvmSuppressWildcards Product>, String> {

    override suspend fun getResult(params: String?): Flow<ResultData<List<Product>>> {
        return productRepository.searchProductName(params!!)
    }
}