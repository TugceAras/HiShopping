...
class GetBrandsDataSource @Inject constructor(private val brandRepository: BrandRepository) :
    (BaseResultFlowAsyncDataSource<List<@JvmSuppressWildcards Brand>, @JvmSuppressWildcards Unit>) {

    override suspend fun getResult(params: Unit?): Flow<ResultData<List<Brand>>> {
