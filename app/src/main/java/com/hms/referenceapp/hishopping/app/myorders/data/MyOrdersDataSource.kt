...
class MyOrdersDataSource @Inject constructor(private val orderRepository: OrderRepository) :
    BaseRetrieveResultFlowAsyncDataSource<List<@JvmSuppressWildcards Order>> {

    override suspend fun getResult(): Flow<ResultData<List<Order>>> {
