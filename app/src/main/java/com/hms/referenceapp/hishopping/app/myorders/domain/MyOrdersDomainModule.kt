...
abstract class MyOrdersDomainModule {

    @get:Binds
    abstract val GetMyOrdersUseCase.getMyOrderUseCase: BaseRetrieveResultFlowAsyncUseCase<List<OrderViewItem>>

    @get:Binds
    abstract val UpsertOrderUseCase.addOrderUseCase: BaseResultFlowAsyncUseCase<Unit, OrderEntity>
