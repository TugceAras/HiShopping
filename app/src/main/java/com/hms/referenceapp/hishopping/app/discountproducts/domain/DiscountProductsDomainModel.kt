...
abstract class DiscountProductsDomainModel {

    @get:Binds
    abstract val GetDiscountProductsUseCase.useCase:
            BaseResultFlowAsyncUseCase<List<Product>, DiscountProductsRequest>
