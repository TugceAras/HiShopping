...
abstract class SearchDataModule {
    ...
    @get:Binds
    abstract val SearchDataSource.searchDataSource: BaseResultFlowAsyncDataSource<List<Product>, String>

    @get:Binds
    abstract val SearchRepositoryImpl.repo: SearchRepository
