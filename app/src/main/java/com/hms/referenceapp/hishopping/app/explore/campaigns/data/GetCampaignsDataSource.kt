...
class GetCampaignsDataSource @Inject constructor(private val campaignRepository: CampaignRepository) :
    (BaseResultFlowAsyncDataSource<List<@JvmSuppressWildcards Campaign>, @JvmSuppressWildcards Unit>) {

    override suspend fun getResult(params: Unit?): Flow<ResultData<List<Campaign>>> {
