...
class ArProductsRepositoryImpl @Inject constructor(
    @ArProductsDataSource private val getArProductsDataSource:
    BaseResultFlowAsyncDataSource<List<@JvmSuppressWildcards Product>, @JvmSuppressWildcards Unit>
) :
    ArProductsRepository {
    override suspend fun getArProducts(): Flow<ResultData<List<Product>>> {
        return getArProductsDataSource.getResult()
    }
