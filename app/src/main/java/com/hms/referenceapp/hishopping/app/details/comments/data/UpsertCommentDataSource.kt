...
class UpsertCommentDataSource @Inject constructor(private val commentRepository: CommentRepository) :
    BaseResultFlowAsyncDataSource<@JvmSuppressWildcards Unit, @JvmSuppressWildcards Comment> {
    override suspend fun getResult(params: Comment?): Flow<ResultData<Unit>> {
        return commentRepository.upsert(params!!)
    }
}