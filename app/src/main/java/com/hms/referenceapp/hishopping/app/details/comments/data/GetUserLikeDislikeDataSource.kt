...
class GetUserLikeDislikeDataSource @Inject constructor(private val userLikeDislikeRepository: UserLikeDislikeRepository) :
    (BaseResultFlowAsyncDataSource<@JvmSuppressWildcards LikeDislikeHolder, @JvmSuppressWildcards Unit>) {

    override suspend fun getResult(params: Unit?): Flow<ResultData<LikeDislikeHolder>> {
        return userLikeDislikeRepository.getUsersLikeDislikeList()
    }
}