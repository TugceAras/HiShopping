...
abstract class CategoryProductsDomainModel {

    @get:Binds
    abstract val GetCategoryProductsUseCase.useCase:
            BaseResultFlowAsyncUseCase<List<Product>, CategoryProductsRequest>
