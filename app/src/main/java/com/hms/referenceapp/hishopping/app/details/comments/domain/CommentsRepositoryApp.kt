...
interface CommentsRepositoryApp {
    suspend fun getComments(query: Int): Flow<ResultData<List<Comment>>>
    suspend fun upsertComments(query: Comment): Flow<ResultData<Unit>>
