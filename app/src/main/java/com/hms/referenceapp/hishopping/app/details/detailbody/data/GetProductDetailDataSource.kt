...
class GetProductDetailDataSource @Inject constructor(private val productRepository: ProductRepository) :
    BaseResultFlowAsyncDataSource<Product, Int> {

    override suspend fun getResult(params: Int?): Flow<ResultData<Product>> {
        return productRepository.loadById(params!!)
    }
}