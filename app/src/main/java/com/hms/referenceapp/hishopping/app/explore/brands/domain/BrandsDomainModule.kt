...
abstract class BrandsDomainModule {
    @get:[Binds BrandsUseCase]
    abstract val GetBrandsUseCase.brandRepo: BaseResultFlowAsyncUseCase<List<Brand>, Unit>
}


@Qualifier
@Retention(AnnotationRetention.BINARY)
annotation class BrandsUseCase
