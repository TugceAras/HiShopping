...
class UpsertCommentUseCase @Inject constructor(private val commentsRepositoryApp: CommentsRepositoryApp) :
    BaseResultFlowAsyncUseCase<Unit, Comment> {

    override suspend fun execute(params: Comment?): Flow<ResultData<Unit>> {
        return commentsRepositoryApp.upsertComments(params!!)
    }
}