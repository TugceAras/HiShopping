...
class GetAllAddressesUseCase @Inject constructor(private val repository: UserAddressRepository):
        BaseResultFlowAsyncUseCase<List<@JvmSuppressWildcards UserAddress>,String>{
    override suspend fun execute(params: String?): Flow<ResultData<List<UserAddress>>> {
        return repository.getUserAddresses(params!!)
    }
}