...
class ProductDataSource @Inject constructor(private val productRepository: ProductRepository) {

    suspend fun getProductById(id: Int): ResultData<Product> {
        return productRepository.loadById(id).reduce { _, value ->
            value
        }
    }
}