...
class DeleteCreditCardByCardNumberUseCase @Inject constructor(private val creditCardRepository: CreditCardRepository) :
    BaseResultFlowAsyncUseCase<Any, String> {
    override suspend fun execute(params: String?): Flow<ResultData<Any>> =
        creditCardRepository.delete(params!!)
}